...
## ℹ️ Sobre o projeto
Este foi um projeto do módulo de Back-End da [Trybe](https://www.betrybe.com/), onde colocamos em prática conhecimentos adquiridos sobre banco de dados NoSQL, utilizando o Sistema de Gerenciamento de Banco de Dados [MongoDB](https://www.mongodb.com/). Trabalhamos com dados do IMDB, dados sobre empresas aéreas e também dados que contém registros de deslocamento de pessoas que utilizam bicicletas.
Essas coleções foram utitilizadas para que pudéssemos praticar em vários cenários os diversos operadores e estágios do `aggregation pipeline`. A seguir há uma lista das habilidades praticadas neste projeto:
...
Neste projeto foi utilizado o MongoDB para realizar os requisitos propostos.
- Tutorial de como [instalar o MongoDB](https://docs.mongodb.com/manual/installation/)
